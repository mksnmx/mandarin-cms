...
class ControllerExtensionPaymentMandarinbank extends Controller {
	...
	public function index() {
		...
		$data['help_mandarinbank_status'] = $this->language->get('help_mandarinbank_status');
		...
		$data['entry_mandarinbank_status'] = $this->language->get('entry_mandarinbank_status');
		...
		$data['breadcrumbs'] = array();
   		...
   		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/payment/mandarinbank', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);

		$data['action'] = $this->url->link('extension/payment/mandarinbank', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->server['HTTPS']) && (($this->request->server['HTTPS'] == 'on') || ($this->request->server['HTTPS'] == '1'))) {
			$data['mandarinbank_result_url'] = HTTPS_CATALOG . 'index.php?route=extension/payment/mandarinbank/callback';
		} else {
			$data['mandarinbank_result_url'] = HTTP_CATALOG . 'index.php?route=extension/payment/mandarinbank/callback';
		}
		...
		$this->response->setOutput($this->load->view('/extension/payment/mandarinbank.tpl', $data));
